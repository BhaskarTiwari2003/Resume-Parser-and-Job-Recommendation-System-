...
# Load models===========================================================================================================
rf_classifier_categorization = pickle.load(open('/Users/bhaskartiwari/AIDS Project/backend/models/rf_classifier_categorization.pkl', 'rb'))
tfidf_vectorizer_categorization = pickle.load(open('/Users/bhaskartiwari/AIDS Project/backend/models/tfidf_vectorizer_categorization.pkl', 'rb'))
rf_classifier_job_recommendation = pickle.load(open('/Users/bhaskartiwari/AIDS Project/backend/models/rf_classifier_job_recommendation.pkl', 'rb'))
tfidf_vectorizer_job_recommendation = pickle.load(open('/Users/bhaskartiwari/AIDS Project/backend/models/tfidf_vectorizer_job_recommendation.pkl', 'rb'))
